...
export default function BrickYardModal({ isVisible, setIsVisible }) {
    ...
    const upgradeCost = brickYard?.resourceCost
        ? {
            wood: Math.floor((brickYard?.resourceCost?.wood ?? 0) * 1.2),
            clay: Math.floor(brickYard.resourceCost.clay * 1.2),
            iron: Math.floor(brickYard.resourceCost.iron * 1.2),
        }
    ...
    const nextLevel = brickYard.built ? brickYard.level + 1 : 1;

    // Required Town Hall level for the next Warehouse level
    const requiredTownHallLevel = brickYard.upgradeRequirement?.[nextLevel - 1] || 0;
        ...
        <SlidingModal isVisible={isVisible} setIsVisible={setIsVisible}>
            <View style={styles.modalContent}>
                <View style={{ flexDirection: "row" }}>
                    <Image
                        source={require("../../assets/images/brickyardIcon.png")}
                        style={styles.buildingIcon}
                    />
                    <View>
                        <Text style={styles.modalTitle}>Brickyard</Text>
                        <Text style={styles.levelText}>Level: {brickYard.level}</Text>
                    </View>
                </View>
                <View style={{ alignItems: "center" }}>
                    <View style={styles.infoContainer}>
                        ...
                        {brickYard.level < 10 ? (
                                    ...
                                    <View style={{ width: "99%" }}>
                                        ...
                                        >
                                            <View style={styles.upgradebuttonContainer}>
                                                {isUpgrading ? (
                                                    <View style={{ alignItems: 'center' }}>
                                                        <Countdown finishTime={brickYard.finishTime} />
                                                    </View>
                                                ) : (
                            ...
                            <Text style={styles.maxLevelText}>🏛 Brickyard is at Max Level</Text>
                        )}
                    </View>
                </View>
            </View>
