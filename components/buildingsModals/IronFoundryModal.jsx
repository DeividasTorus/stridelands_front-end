...
export default function IronFoundryModal({ isVisible, setIsVisible }) {
    ...
    const upgradeCost = ironFoundry?.resourceCost
        ? {
            wood: Math.floor(ironFoundry.resourceCost.wood * 1.2),
            clay: Math.floor(ironFoundry.resourceCost.clay * 1.2),
            iron: Math.floor(ironFoundry.resourceCost.iron * 1.2),
        }
    ...
    const nextLevel = ironFoundry.built ? ironFoundry.level + 1 : 1;

    // Required Town Hall level for the next Warehouse level
    const requiredTownHallLevel = ironFoundry.upgradeRequirement?.[nextLevel - 1] || 0;
        ...
        <SlidingModal isVisible={isVisible} setIsVisible={setIsVisible}>
            <View style={styles.modalContent}>
                <View style={{ flexDirection: "row" }}>
                    <Image
                        source={require("../../assets/images/ironFoundryIcon.png")}
                        style={styles.buildingIcon}
                    />
                    <View>
                        <Text style={styles.modalTitle}>Iron Foundry</Text>
                        <Text style={styles.levelText}>Level: {ironFoundry.level}</Text>
                    </View>
                </View>
                <View style={{ alignItems: "center" }}>
                    <View style={styles.infoContainer}>
                        ...
                        {ironFoundry.level < 10 ? (
                                    ...
                                    <View style={{ width: "99%" }}>
                                        ...
                                        >
                                            <View style={styles.upgradebuttonContainer}>
                                                {isUpgrading ? (
                                                    <View style={{ alignItems: 'center' }}>
                                                        <Countdown finishTime={ironFoundry.finishTime} />
                                                    </View>
                                                ) : (
                            ...
                            <Text style={styles.maxLevelText}>🏛 Iron Foundry is at Max Level</Text>
                        )}
                    </View>
                </View>
            </View>
